            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Contrabass.Music_Staff"
                      %! khamr.make_empty_score()
                      %! baca.path.extern()
                    { \number.4.Contrabass.Music_Staff }
                    % CLOSING:
                    % COMMANDS:
