...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.04.Saxophone.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.04.Percussion.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.04.Contrabass.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
