...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Saxophone.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Saxophone.RestVoice measure 21]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Saxophone.Music_Staff = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Percussion.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.RestVoice measure 21]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.4.PercussionMusicStaff = {
    ...
    \context Voice = "Percussion.Music_Voice"
      %! khamr.make_empty_score()
      %! baca.path.extern()
    { \number.4.Percussion.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Contrabass.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Contrabass.RestVoice measure 21]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Contrabass.Music_Staff = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "Contrabass.Music_Voice"
      %! khamr.make_empty_score()
      %! baca.path.extern()
    { \number.4.Contrabass.Music_Voice }
    % CLOSING:
    % COMMANDS:
