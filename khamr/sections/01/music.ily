...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.01.Saxophone.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.01.Percussion.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.01.Contrabass.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
