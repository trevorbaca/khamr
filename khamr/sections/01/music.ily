...
number.1.Saxophone.Music_Voice = {
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "Saxophone.RestVoice"
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Saxophone.RestVoice measure 45]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.1.Guitar.Music_Voice = {
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "Guitar.RestVoice"
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.RestVoice measure 45]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.1.Contrabass.Music_Voice = {
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "Contrabass.RestVoice"
          %! PHANTOM
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Contrabass.RestVoice measure 45]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
