...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.02.Saxophone.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.02.Percussion.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.02.Contrabass.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
