...
%@% - \baca_metronome_mark_spanner_left_text 2 0 1 "84"                        %! _attach_metronome_marks(2)
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    - \abjad_invisible_line                                                    %! _attach_metronome_marks(3)
    - \baca_metronome_mark_spanner_colored_left_text 2 0 1 "84" #'blue         %! _attach_metronome_marks(3)
    \startTextSpan                                                             %! _attach_metronome_marks(3)
        ...
        \column                                                                %! IndicatorCommand
            {                                                                  %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
                        "sparse, individual clicks with nail or pick laterally up string" %! IndicatorCommand
                    }                                                          %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
    ...
    ^ \markup {                                                                %! IndicatorCommand
        \column                                                                %! IndicatorCommand
            {                                                                  %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
                        "draw metal screw back and forth slowly across string;" %! IndicatorCommand
                    }                                                          %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
                        "continuous loud sound"                                %! IndicatorCommand
                    }                                                          %! IndicatorCommand
            }                                                                  %! IndicatorCommand
        }                                                                      %! IndicatorCommand
    ...
    ^ \markup {                                                                %! IndicatorCommand
        \column                                                                %! IndicatorCommand
            {                                                                  %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
                        "sparse, individual clicks with extremely slow bow"    %! IndicatorCommand
                    }                                                          %! IndicatorCommand
                \line                                                          %! IndicatorCommand
                    {                                                          %! IndicatorCommand
                        "(1-2/sec. in irregular rhythm)"                       %! IndicatorCommand
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    _ \markup { III+IV }                                                       %! IndicatorCommand
    \override Staff.InstrumentName.color = #(x11-color 'OliveDrab)             %! REDRAWN_REAPPLIED_MARGIN_MARKUP_COLOR:_attach_color_literal(2)
    \set Staff.shortInstrumentName =                                           %! REDRAWN_REAPPLIED_MARGIN_MARKUP:_set_status_tag:_treat_persistent_wrapper(3):-PARTS:_reapply_persistent_indicators(3)
    \markup {                                                                  %! REDRAWN_REAPPLIED_MARGIN_MARKUP:_set_status_tag:_treat_persistent_wrapper(3):-PARTS:_reapply_persistent_indicators(3)
        \hcenter-in                                                            %! REDRAWN_REAPPLIED_MARGIN_MARKUP:_set_status_tag:_treat_persistent_wrapper(3):-PARTS:_reapply_persistent_indicators(3)
