...
maker.validate_measure_count(20)
...
maker(
    baca.scope('PianoMusicVoice', 4, 7),
    baca.RhythmCommand(
        rewrite_meter=True,
        rhythm_maker=rhythmos.NoteRhythmMaker(
            division_masks=[
...
maker(
    baca.scope('GuitarMusicVoice', 1, 8),
    baca.accents(),
    baca.flageolets(),
    baca.pitches('C4'),
...
maker(
    baca.make_scopes(['ViolinMusicVoice', 'ViolaMusicVoice'], [(1, 7)]),
    baca.markup.bow_on_wooden_mute(),
    )

maker(
    baca.make_scopes(['CelloMusicVoice', 'ContrabassMusicVoice'], [(1, 7)]),
