...
%  '4/4', '4/4', '5/4', '6/8', '2/4', '6/4', '2/4', '5/4', '6/8', '4/4',
%  '6/4'
%  ]
...
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__()
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context()
        ...
        {   %*% Page_Layout                                                    %! abjad.ScoreTemplate._make_global_context()
            ...
            \baca-lbsd #60 #'(20 30 30 30 40 30 30 40 30 30 30 40)             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! PHANTOM
            % [Page_Layout measure 45]                                         %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
            %! SPACING_COMMAND
            %! baca.HorizontalSpacingSpecifier.__call__(1)
            %! baca.SegmentMaker._style_phantom_measures(1)
            %! PHANTOM
