...
segment.04.Saxophone.Music.Voice = {
    ...
    <<
        ...
        %! baca._make_multimeasure_rest_container(6)
        {
            ...
            %! baca._comment_measure_numbers()
            % [Saxophone_Rest_Voice measure 16]
            %! baca._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/2
    ...
    <<
        ...
        %! PHANTOM
        {
            ...
            %! baca._style_phantom_measures(5)
            %! PHANTOM
            % [Saxophone_Rest_Voice measure 21]
            %! baca._style_phantom_measures(6)
            %! PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f
            %! baca._style_phantom_measures(7)
...
segment.04.Percussion.Music.Voice = {
    ...
    <<
        ...
        %! baca._make_multimeasure_rest_container(6)
        {
            ...
            %! baca._comment_measure_numbers()
            % [Percussion_Rest_Voice measure 16]
            %! baca._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/2
    ...
    <<
        ...
        %! PHANTOM
        {
            ...
            %! baca._style_phantom_measures(5)
            %! PHANTOM
            % [Percussion_Rest_Voice measure 21]
            %! baca._style_phantom_measures(6)
            %! PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f
            %! baca._style_phantom_measures(7)
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    <<
        ...
        %! baca._make_multimeasure_rest_container(6)
        {
            ...
            %! baca._comment_measure_numbers()
            % [Contrabass_Rest_Voice measure 16]
            %! baca._make_multimeasure_rest_container(5)
            %! REST_VOICE
            %! MULTIMEASURE_REST
            R1 * 1/2
    ...
    <<
        ...
        %! PHANTOM
        {
            ...
            %! baca._style_phantom_measures(5)
            %! PHANTOM
            % [Contrabass_Rest_Voice measure 21]
            %! baca._style_phantom_measures(6)
            %! PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f
            %! baca._style_phantom_measures(7)
